...
func (b *branchRepo) GetAllBranch(c context.Context, req *branch_service.GetAllBranchRequest) (*branch_service.GetAllBranchResponse, error) {
	var (
		resp   branch_service.GetAllBranchResponse
		err    error
		filter string
